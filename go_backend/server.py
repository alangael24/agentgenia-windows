...
class Config:
    def __init__(self):
        ...
        self.pi_node_bin = (os.environ.get("PI_NODE_BIN") or "").strip() or None
        self.pi_node_run_as_electron = os.environ.get("PI_NODE_RUN_AS_ELECTRON", "0") == "1"
...
class Backend:
    def __init__(self, cfg: Config):
        ...
        self.pi = PiHarness(
            ...
            node_binary=cfg.pi_node_bin,
            node_run_as_electron=cfg.pi_node_run_as_electron,
        ...
        try:
            ...
            if self.command == "POST" and path == "/v1/account-auth/start":
                ...
                json_response(self, 200, {
                    ...
                    "pi_enabled": pi_status["enabled"],
                    "pi_available": pi_status["available"],
                    "pi_node_available": pi_status["node_available"],
                    "pi_connectors_available": pi_status["connectors_available"],
                    "pi_chrome_extension_installed": pi_status["browser_extension_installed"],
                })
            else:
